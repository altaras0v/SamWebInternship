                        ...
                        <div role="main"><span id="maincontent"></span>
                           ...
                           <c:if test="${listQuestion.size()!=0}"> <div class="coursebox clearfix odd first collapsed" data-courseid="6"
                            ...
                            <td><form:form name="quest" action="../addQuestion" method="get">
                                <c:if test="${testDTO!=null}"> <button   type="submit" name="testId"
                                                                          value="${testDTO.id}" style="color: #3c867c;font-size: 16px" class="btn btn-link"><a style="text-transform: capitalize"> Add question </a></button></c:if>
