                    ...
                    <li class="dropdown nav-item">
                        ...
                        <div class="dropdown-menu" aria-labelledby="drop-down-5d13563a361e95d13563a26a1e5">
                            <a class="dropdown-item" href="http://moodle.lmsace.com/?lang=en" title="English ‎(en)‎">English
                                ‎(en)‎</a>
                            <a class="dropdown-item" href="http://moodle.lmsace.com/?lang=ar" title="عربي ‎(ar)‎">عربي
                                ‎(ar)‎</a>
                        </div>
                    </li>
...
<link rel="stylesheet" href="http://moodle.lmsace.com/theme/eguru/style/slick.css"/>
...
<div class="custom-site-expo">
    <div class="container">
        ...
        <div id="frontpage-category-combo"><h2>Courses</h2>
...
<div id="page" class="container">
    ...
    <script src="http://moodle.lmsace.com/theme/eguru/javascript/slick.js"></script>
    <script>
        $(function () {
...
<script type="text/javascript" src="http://moodle.lmsace.com/lib/javascript.php/-1/lib/requirejs/require.js"></script>
<script type="text/javascript">
    //<![CDATA[
    require(['core/first'], function () {
        ...
        require(['jquery'], function ($) {
            $('#single_select5d1200650b2533').change(function () {
                var ignore = $(this).find(':selected').attr('data-ignore');
                if (typeof ignore === typeof undefined) {
                    $('#single_select_f5d1200650b2532').submit();
                }
            });
        });
        ;
        ...
        require(['jquery'], function ($) {
            $('#single_select5d1200650b2537').change(function () {
                var ignore = $(this).find(':selected').attr('data-ignore');
                if (typeof ignore === typeof undefined) {
                    $('#single_select_f5d1200650b2536').submit();
                }
            });
        });
        ;
...
<script type="text/javascript">
    ...
    (function () {
        ...
        M.util.js_pending('random5d1200650b25310');
        Y.on('domready', function () {
            M.util.js_complete("init");
            M.util.js_complete('random5d1200650b25310');
        });
    })();
    //]]>
</script>
